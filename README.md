...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-09-project-trivia-react-redux.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-09-project-trivia-react-redux`
...
6. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-09-project-trivia-react-redux/pulls)
  ...
  * Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-09-project-trivia-react-redux/pulls) e confira que o seu _Pull Request_ está criado
